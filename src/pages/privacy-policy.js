          ...
          <Row className="mb-2 mb-sm-5 pb-0 pb-sm-5 mx-0 no-gutters">
            <Col sm="12">
              ...
              <p className="filson-pro-reg text-1 color-secondary">
                Chirofoam<sup>TM</sup>Mattress Company (www.chirofoam.com)
                Privacy Policy
              </p>
              <p className="filson-pro-reg text-1 color-secondary">
              ...
              <p className="filson-pro-reg text-1 color-secondary">
                We collect information from you when you place an order, fill
                out a form, Open a Support Ticket or enter information on our
                site.
              </p>
              <p className="filson-pro-reg text-1 color-secondary">
              ...
              <p className="filson-pro-reg text-1 color-secondary">
                ...
                future emails, you can email us at info@chirofoam.com and we
              ...
              <p className="filson-pro-reg text-1 color-secondary">
                If there are any question regarding this privacy policy you may
