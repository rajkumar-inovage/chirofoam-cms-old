          ...
          <div className="container">
            <Row className="mb-2 mb-sm-5 pb-0 pb-sm-5">
              <Col className="mb-3 mb-sm-5">
                <h5 className="color-primary mb-0 text-uppercase">
                  AFFILIATE REGISTRATION
                </h5>
                <p
                  className="filson-pro-reg color-secondary"
                  style={{ fontSize: '14px' }}
                >
                  Fields marked with an <span style={{ color: 'red' }}>*</span>{' '}
                  are required
                </p>
                <div className="row">
                  <Col>
                  ...
                  <Col>
                    <FormGroup>
                      <Label
                        ...
                        className="color-secondary filson-pro-reg"
                      >
                        Payment Email <span style={{ color: 'red' }}>*</span>
                      </Label>
                      <input
                        type="email"
                        className="form-control"
                  ...
                  <Col>
                    <FormGroup>
                      <Label
                        ...
                        className="color-secondary filson-pro-reg"
                      >
                        Promotion Method <span style={{ color: 'red' }}>*</span>
                      </Label>
                      <textarea
                        class="form-control"
                        rows="8"
                    ...
                    <FormGroup>
                      ...
                      <p>
                        ...
                        <span className="color-secondary filson-pro-reg pl-4">
                          ...
                          of the Chirofoam Mattress Company Affiliate Program.
                        </span>
                      </p>
                    </FormGroup>
                  </Col>
