...
const Reviews = props => {
  ...
  const externalCloseBtn = (
    <button
      className="close d-none d-md-inline-block"
      style={{
        position: 'absolute',
        top: '0',
        right: '15px',
  ...
  useEffect(() => {
    ...
    const fetchShopID = async URL => {
      ...
      res.json().then(responseJson => {
        ...
        fetchAllRating(
          `//reviews.hulkapps.com/api/shop/${responseJson.data.shopify_id}/reviews/all`
        )
      })
    }
        ...
        <Container>
          <Row className="mx-0">
            <Jumbotron className="mb-0 text-center text-white bg-transparent space-1 w-100 m-auto">
              ...
              <ScrollAnimation animateIn="fadeInUp">
                <p
                  className="filson-pro-reg color-primary space-2 pt-5"
                  style={{
                    fontSize: '24px',
                  }}
                >
          ...
          <Row>
            <div className="col-md-12">
              <Nav
                tabs={true}
                id="tabs"
                className="nav-fill flex-md-wrap flex-nowrap"
              >
              ...
              <TabContent activeTab={activeTab}>
                <TabPane tabId="1">
                  ...
                  >
                    <div
                      id="customer-revieew"
                      className="col-12 col-md-10 m-auto pb-5 position-relative"
                    >
                      {avgRating === 0 && (
                        <div
                          className="h-100 w-100 bg-white d-flex justify-content-center align-items-center position-absolute"
                          style={{
                            zIndex: 1,
                          }}
                        >
                          <div
                            className="spinner-border color-primary"
                            role="status"
                            style={{
                              width: '5rem',
                              height: '5rem',
                      ...
                      <Row className="mx-0 align-items-center">
                        <Col md="6" className="pt-5 p-sm-0 text-center col-12">
                          <p className="erbaum-bold color-secondary pt-5 mt-3">
                        ...
                        <Col md="6" className="py-5 col-12">
                          <div className="p-0 list-unstyled col-md-9 review-details">
                            {Object.keys(overAllRating)
                              .reverse()
                              .map(index => (
                                <div
                                  key={index}
                                  className="w-100 d-flex color-primary mb-4"
                                >
                                  <span>{index}</span>
                                  ...
                                  <div className="progress rounded-0 bg-transparent p-0 flex-grow-1 mt-1">
                                    <div
                                      ...
                                      style={{
                                        width:
                                          (overAllRating[index] / totalRating) *
                                            100 +
                                          '%',
                      ...
                      <Row className="mx-0">
                        <div className="w-100 m-auto">
                          <ul className="list-unstyled d-inline-block p-0 mb-0 ratings">
                            {data.slice(0, showReviews).map((review, index) => (
                          ...
                          <div className="position-relative">
                            ...
                            {data.length >= showReviews && (
                              <p className="cta mt-0 mt-sm-3 pt-sm-4 pt-lg-4 pt-xl-4 mb-sm-2 pl-0 text-center">
                                <button
                                  className="btn-cta color-primary erbaum-bold space-1 bg-transparent border-0 p-0"
                ...
                <TabPane tabId="2">
                  ...
                  >
                    <div
                      id="leave-review"
                      className="m-auto py-5 col-12 col-sm-10 col-lg-10 col-xl-10 p-0 px-sm-2"
                    >
                      {response}
                      <Row>
                            ...
                            {allShopifyProduct.nodes.map((item, i) => (
                              <div key={i} className="col-md-6 col-10 mx-auto">
                                <div className="card card-body text-center border-0 px-0 px-sm-2 px-lg-2 px-xl-2 mx-1">
                                  ...
                                  <p className="filson-pro-reg pt-4 color-secondary">
                                    Click here to add your reviews for our{' '}
                                    {item.title}
                                  </p>
                                </div>
                              </div>
      ...
      >
        <form encType="multipart/form-data" onSubmit={e => submitReview(e)}>
          <div className="modal-header border-bottom-0 position-relative">
            ...
            <button
              type="button"
              className="close m-0 d-md-none position-absolute"
              onClick={closeModal}
              aria-label="Close"
              style={{
                top: 0,
            ...
            <button
              ...
              className={
                submitting
                  ...
                  : 'btn btn-custom-primary text-white'
              }
              style={{
                opacity: 1,
              }}
