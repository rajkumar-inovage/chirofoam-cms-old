      ...
      <section className="mb-0 py-3 py-sm-5">
        <div className="container-large">
          <Row className="border border-info bg-light">
            <p className="color-secondary mt-2 ml-5 p-1">
              Returning customers? <Link to="#">Click here to login.</Link>
            </p>
          </Row>
          ...
          <div className="container-large">
            <Row className="mb-2 mb-sm-5 pb-0 pb-sm-5">
              <Col sm="6" className="mb-3 mb-sm-5">
                <h5 className="color-primary pb-2 pb-sm-5 mb-0 text-uppercase">
                  BILLING DETAILS
                </h5>
                <div className="row">
                  <div className="col-6">
                    <FormGroup>
                      <Label
                        for="fname"
                        className="color-secondary filson-pro-reg"
                      >
                  ...
                  <div className="col-12">
                    <FormGroup>
                      <Input
                        ...
                        className="ml-1"
                      />
                      <span className="color-secondary filson-pro-reg pl-4">
                        Create an account?
                      </span>
                    </FormGroup>
                  </div>
              ...
              <Col sm="6" className="mb-3 mb-sm-5">
                <FormGroup>
                  ...
                  <h5 className="color-primary pb-2 pb-sm-4 mb-0 text-uppercase">
              ...
              <div className="col-12 cart-total">
                <h4 className="erbaum-bold text-uppercase pt-1 space-2">
                  YOUR ORDER
                </h4>
                <Table className="text-center color-secondary">
                  ...
                  <tbody>
                    ...
                    <tr className="cart_item">
                      <td>ORDER TOTAL</td>
                      <td className="text-center color-primary font-weight-bold">
                        CAD $840.00
                      </td>
                    </tr>
                  </tbody>
              ...
              <div className="col-12">
                <FormGroup>
                  <Label>
                    ...
                    />{' '}
                    Paypal <img src={paypal} alt="Paypal" /> What is Paypal?
                  </Label>
                  <br />
                  <p className="color-secondary p-2 bg-light">
                  ...
                  <Label>
                    <Input
                      ...
                      className="position-relative"
                    />{' '}
                    Credit Card (Via PayPal Secure Server){' '}
                    <img src={cards} alt="Cards" />
                  </Label>
                </FormGroup>
              </div>
              <div className="col-12">
                <p className="color-secondary p-2">
              ...
              <div className="col-12">
                <FormGroup>
                  ...
                  <span className="color-secondary filson-pro-reg">
              ...
              <div className="col-12 pt-5 checkout">
                <button className="btn p-2 text-white space-1 float-right font-weight-bold btn-checkout">
                  {' '}
                  PROCEED TO PAYPAL{' '}
                </button>
              </div>
        ...
        <div className="container-large pb-0 pb-sm-5">
          <Row>
            ...
            <p
              ...
              style={{ fontSize: '20px' }}
            >
              “A great quality mattress I enjoy waking up on every day…” <br />{' '}
