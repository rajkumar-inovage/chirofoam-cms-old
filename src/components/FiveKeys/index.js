        ...
        <div className="card-bg1 keys card-bg bg-image mb-4 mb-sm-0">
          <div className="card-layer">
            ...
            <div className="card-data text-white position-absolute p-3">
              <h4 className="erbaum-bold pr-0 pr-sm-0 pr-lg-2 pf-xl-5 text-uppercase" style={{
                  fontSize: '18px'
                }}>PRESSURE RELIEF FOAM</h4>
              <p className="proxima-r text-1" style={{
                  letterSpacing: '1px'
        ...
        <div className="card-bg2 keys card-bg bg-image mb-4 mb-sm-0">
          <div className="card-layer">
            ...
            <div className="card-data text-white position-absolute p-3">
              <h4 className="erbaum-bold pr-0 pr-sm-0 pr-lg-2 pf-xl-5 text-uppercase" style={{
                  fontSize: '18px'
                }}>PROPPER BACK SUPPORT AND ALIGNMENT</h4>
              <p className="proxima-r text-1" style={{
                  letterSpacing: '1px'
                }}>The majority of people go by their daily life with improper posture while sitting, standing, or lifting heavy objects. This improper posture puts unnecessary strain on your back which leads to back pain and potentially more serious health problems in the future.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="card-bg4 keys card-bg bg-image mb-4 mb-sm-0">
          <div className="card-layer">
            ...
            <div className="card-data text-white position-absolute p-3">
              ...
              <p className="proxima-r text-1" style={{
                  letterSpacing: '1px'
                }}>Partner movement while you sleep can be felt across a mattress with traditional coils. This is caused by tossing and turning during the night and can affect the sleep pattern of the person sleeping as well as the partner they are sleeping with.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="card-bg5 keys card-bg bg-image mb-4 mb-sm-0">
          <div className="card-layer">
            ...
            <div className="card-data text-white position-absolute p-3">
              ...
              <p className="proxima-r text-1" style={{
                  letterSpacing: '1px'
                }}>One of the most common problems people have which causes them to replace their mattress is sagging. These dips in the mattress are caused by years of use and often lead to great discomfort and irritable sleep.</p>
            </div>
          </div>
        </div>
      </div>
