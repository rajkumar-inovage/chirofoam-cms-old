  ...
  */
  ...
  return (
    <>
        ...
        <div>
          {options[0].values.map((value, index) => (
            <Button
              ...
              color=""
              className=" border color-secondary variants rounded font-italic mr-1 py-2 px-2 style={{fontSize:'.5rem'}}"
            >
              {value}
            </Button>
          ))}
      ...
      {
        <h4 className="mt-2" style={{ fontSize: '14px' }}>
          {get_selectedDimension()}
        </h4>
      }
      ...
      <p className="cta mt-0 mt-sm-5 pt-sm-4 pt-lg-4 pt-xl-4 mb-sm-2 pl-0 text-right pr-2 pr-sm-3 pr-md-4 pr-lg-5 pr-xl-5">
        ...
        <button
          className="btn-cta color-primary erbaum-bold space-1 bg-transparent border-0 add-to-cart"
