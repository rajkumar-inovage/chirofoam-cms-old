    ...
    <div className={wrapperClass}>
      <div className="test-content-slider-tab">
        <div className="test-content-slider-title">
          <button
            className="fs-1 fs-lg-2 py-1 px-2 py-lg-2 px-lg-3 proxima-b"
            onClick={openTakeTest}
          >
        ...
        <div className="test-slider-content hidden">
          <div className="text-center">
            <h4>
              <span>Take The Chirofoam Test</span>
            </h4>
            <p>
              <span>See if Chirofoam is right for you.</span>
            </p>
          ...
          <button
            className="test-close-slider-content btn text-white btn-custom-secondary rounded-0 p-0"
            onClick={closeTakeTest}
          >
            &times;
          </button>
        </div>
